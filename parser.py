...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--n_day_range", default=10, type=int)
    parser.add_argument("--df_batch_size", default=128, type=int)
    parser.add_argument("--origin_label", default=True, type=bool)
    parser.add_argument("--train_pickle", default='./preprocess_data/train_origin_label.pickle', type=str)
    parser.add_argument("--public_pickle", default='./preprocess_data/public_origin_label.pickle', type=str)
    parser.add_argument("--private_pickle", default='./preprocess_data/private_origin_label.pickle', type=str)
    parser.add_argument("--train_preprocessed_pickle", default='./preprocess_data/train_preprocessed_origin_label.pickle', type=str)
    parser.add_argument("--public_preprocessed_pickle", default='./preprocess_data/public_preprocessed_origin_label.pickle', type=str)
    parser.add_argument("--private_preprocessed_pickle", default='./preprocess_data/private_preprocessed_origin_label.pickle', type=str)
    # optimizer
