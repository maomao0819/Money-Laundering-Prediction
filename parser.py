...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--df_batch_size", default=64, type=int)
    parser.add_argument("--train_pickle", default='./preprocess_data/train.pickle', type=str)
    parser.add_argument("--public_pickle", default='./preprocess_data/public.pickle', type=str)
    parser.add_argument("--train_preprocessed_pickle", default='./preprocess_data/train_preprocessed.pickle', type=str)
    parser.add_argument("--public_preprocessed_pickle", default='./preprocess_data/public_preprocessed.pickle', type=str)
    # optimizer
